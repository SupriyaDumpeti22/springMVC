package com.feujiCompany.Configuration;
...
public class HibernateConfig {
	...
	public DataSource dataSource() {
		...
		dataSource.setPassword(environment.getRequiredProperty("pass_word"));
		return dataSource;
	}
	...
	public LocalSessionFactoryBean sessionFactory() {
		...
		sessionFactory.setPackagesToScan(new String[] { "com.feujiCompany.DTO" });
